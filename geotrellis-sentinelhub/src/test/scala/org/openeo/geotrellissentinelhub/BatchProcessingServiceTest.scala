...
class BatchProcessingServiceTest {
  ...
  def startBatchProcessForOverlappingPolygons(): Unit = {
    ...
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      polygons,
      crs = LatLng,
      from_datetime = "2021-04-03T00:00:00+00:00",
      until_datetime = "2021-04-04T00:00:00+00:00",
      band_names = Arrays.asList("VH", "VV"),
      SampleType.FLOAT32,
      metadata_properties = Collections.emptyMap[String, JMap[String, Any]],
      processing_options = Collections.emptyMap[String, Any]
  ...
  def startBatchProcessForOrbitDirection(): Unit = {
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      bbox = Extent(2.59003, 51.069, 2.8949, 51.2206),
      bbox_srs = "EPSG:4326",
      from_datetime = "2019-10-08T00:00:00+00:00",
      until_datetime = "2019-10-13T00:00:00+00:00",
      band_names = Arrays.asList("VH", "VV"),
      SampleType.FLOAT32,
  ...
  def startBatchProcessForEoCloudCover(): Unit = {
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      bbox_srs = "EPSG:4326",
      from_datetime = "2019-09-21T00:00:00+00:00",
      until_datetime = "2019-09-22T00:00:00+00:00",
  ...
  def startBatchProcessForModis(): Unit = {
    ...
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      bbox_srs = "EPSG:4326",
      from_datetime = "2019-10-01T00:00:00+00:00",
      until_datetime = "2019-10-02T00:00:00+00:00",
  ...
  def startBatchProcessForMapzenDem(): Unit = {
    ...
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      bbox = Extent(2.59003, 51.069, 2.8949, 51.2206),
      bbox_srs = "EPSG:4326",
      from_datetime = "2020-01-01T00:00:00+00:00",
      until_datetime = "2020-01-02T00:00:00+00:00",
  ...
  def startCard4LBatchProcesses(): Unit = {
    ...
    val batchRequestIds = batchProcessingService.start_card4l_batch_processes(
      ...
      bbox_srs = "EPSG:4326",
      from_datetime = "2021-02-01T00:00:00+00:00",
      until_datetime = "2021-02-18T00:00:00+00:00",
  ...
  def startCard4LBatchProcessesForOrbitDirection(): Unit = {
    ...
    val batchRequestIds = batchProcessingService.start_card4l_batch_processes(
      ...
      bbox = Extent(35.666439, -6.23476, 35.861576, -6.075694),
      bbox_srs = "EPSG:4326",
      from_datetime = "2021-01-25T00:00:00+00:00",
      until_datetime = "2021-02-18T00:00:00+00:00",
      band_names = Arrays.asList("VH", "VV", "dataMask", "localIncidenceAngle"),
      dem_instance = null,
  ...
  def startBatchProcessForSparsePolygons(): Unit = {
    ...
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      polygons,
      crs,
      from_datetime = "2020-11-05T00:00:00+00:00",
      until_datetime = "2020-11-06T00:00:00+00:00",
      band_names = Arrays.asList("VH", "VV"),
      SampleType.FLOAT32,
      metadata_properties = Collections.emptyMap[String, JMap[String, Any]],
      processing_options = Collections.emptyMap[String, Any]
  ...
  def startBatchProcessForColombia(): Unit = {
    ...
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      bbox = polygon.extent,
      bbox_srs = "EPSG:4326",
      from_datetime = "2021-04-28T00:00:00+00:00",
      until_datetime = "2021-05-09T00:00:00+00:00",
  ...
  def startBatchProcessWithErrorSentinel1BandMissing(): Unit = {
    val batchRequestId = batchProcessingService.start_batch_process(
      ...
      bbox_srs = "EPSG:32633",
      from_datetime = "2017-03-03T00:00:00+00:00",
      until_datetime = "2017-03-04T00:00:00+00:00",
