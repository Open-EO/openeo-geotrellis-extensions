...
public class testFirstInBlockProcessor {
    ...
    public void testWaterVaporCalculatorBlockCalculator() {
    	...
    	Tile smbt=new FirstInBlockProcessor().computeDoubleBlocks(mbt,3,0.,0.,Double.NaN, null, new WaterVaporCalculator() {
			@Override
    ...
    public void testWaterVaporCalculatorAverage() {
    	...
    	Tile at=new FirstInBlockProcessor().replaceNoDataWithAverage(t, Double.NaN);
