...
public class BatchJobProgressListener extends SparkListener {

    private static final Logger logger = LoggerFactory.getLogger(BatchJobProgressListener.class);
    ...
    public void onStageCompleted(SparkListenerStageCompleted stageCompleted) {
        ...
        Map<String, AccumulatorV2<Object, Object>> accumulators = taskMetrics.nameToAccums();
