...
object NetCDFCollection {
  ...
  private def loadEmptyCollection(polygons: ProjectedPolygons, from_date: String, to_date: String, dataCubeParameters: DataCubeParameters, sc: SparkContext): RDD[(SpaceTimeKey, MultibandTile)] with Metadata[TileLayerMetadata[SpaceTimeKey]] = {
