...
class HDFRasterSourceProvider extends RasterSourceProvider {
  ...
  override def rasterSource(definition: RasterSourceDefinition): RasterSource = {
    ...
    val band = collectionId match {
      ...
      case "modis-aqua-myd16a3gf" => s":MOD_Grid_MOD16A3:$bandName"
      case "modis-aqua-myd17a2h" => s":MOD_Grid_MOD17A2H:$bandName"
      case "modis-aqua-myd17a2hgf" => s":MOD_Grid_MOD17A2H:$bandName"
      case "modis-aqua-myd17a3hgf" => s":MOD_Grid_MOD17A3H:$bandName"
      ...
      case "modis-terra-mod16a3gf" => s":MOD_Grid_MOD16A3:$bandName"
      case "modis-terra-mod17a2h" => s":MOD_Grid_MOD17A2H:$bandName"
      case "modis-terra-mod17a2hgf" => s":MOD_Grid_MOD17A2H:$bandName"
      case "modis-terra-mod17a3hgf" => s":MOD_Grid_MOD17A3H:$bandName"
      case "modis-terra-mod21a2" => s":MODIS_Grid_8Day_1km_LST21:$bandName"
      case "modis-terraaqua-mcd12q1" => s":MCD12Q1:$bandName"
