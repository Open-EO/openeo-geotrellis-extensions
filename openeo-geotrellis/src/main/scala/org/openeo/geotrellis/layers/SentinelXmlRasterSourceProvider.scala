...
import geotrellis.raster.{ConvertTargetCellType, GridExtent, RasterExtent, RasterSource, ShortConstantNoDataCellType, TargetCellType, TargetRegion, UByteUserDefinedNoDataCellType, UShortConstantNoDataCellType}
...
object SentinelXmlRasterSourceProvider extends SentinelXmlRasterSourceProvider

class SentinelXmlRasterSourceProvider extends ItemRasterSourceProvider {

  private implicit val logger: Logger = LoggerFactory.getLogger(classOf[SentinelXmlRasterSourceProvider])
