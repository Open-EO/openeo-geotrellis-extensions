...
object RegridFixed {
  /**
   * This is a copy of geotrellis Regrid, which set force=true when cropping tiles.
   * This avoids memory inflation during shuffle of the rdd.
   * https://github.com/Open-EO/openeo-geotrellis-extensions/issues/191
   *
   * @param start
   * @param end
   * @param ordering$N$0
