...
class OpenEOProcessScriptBuilder {
  ...
  def expressionEnd(operator:String,arguments:java.util.Map[String,Object]): Unit = {
    ...
    val xyConstantComparison = hasXY && (arguments("x").isInstanceOf[String] || contextStack.head("x").isInstanceOf[AnyProcess] || arguments("y").isInstanceOf[String] || contextStack.head("y").isInstanceOf[AnyProcess])
