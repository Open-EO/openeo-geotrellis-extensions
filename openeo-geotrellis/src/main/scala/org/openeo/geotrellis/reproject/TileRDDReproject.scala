...
package org.openeo.geotrellis.reproject
...
import org.openeo.geotrellis.reproject.RasterRegionReproject
...
object TileRDDReproject {
  ...
  def apply[
    ...
    val rrp = implicitly[org.openeo.geotrellis.reproject.RasterRegionReproject[V]]
