...
import geopyspark.geotrellis.Constants.{GDAL, GEOTRELLIS}
import geopyspark.geotrellis.{PartitionStrategy, ProjectedRasterLayer, SpatialTiledRasterLayer, GlobalLayout => GPSGlobalLayout, LayoutType => GPSLayoutType, LocalLayout => GPSLocalLayout}
